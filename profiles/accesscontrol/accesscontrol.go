...
type SetAccessPointAuthenticationProfile struct {
	...
	AuthenticationProfileToken *ReferenceToken `xml:"AuthenticationProfileToken,omitempty"`
}
...
type ExternalAuthorization struct {
	...
	AccessPointToken *ReferenceToken `xml:"AccessPointToken,omitempty"`
	...
	Decision *Decision `xml:"Decision,omitempty"`
}
...
type ServiceCapabilities struct {
	...
	MaxAccessPoints uint32 `xml:"MaxAccessPoints,attr,omitempty"`

	//
	// Indicates the maximum number of areas supported by the device.
	//

	MaxAreas uint32 `xml:"MaxAreas,attr,omitempty"`
...
type AccessPointInfoBase struct {
	*DataEntity
	...
	//
	AreaFrom *ReferenceToken `xml:"AreaFrom,omitempty"`

	// Optional reference to the Area to which access is requested.
	//
	AreaTo *ReferenceToken `xml:"AreaTo,omitempty"`
...
type AccessPointInfo struct {
	*AccessPointInfoBase
	...
	Capabilities *AccessPointCapabilities `xml:"Capabilities,omitempty"`
}
...
type AccessPointCapabilities struct {
	...
	//
	SupportedSecurityLevels []*ReferenceToken `xml:"SupportedSecurityLevels,omitempty"`
	...
	DisableAccessPoint bool `xml:"DisableAccessPoint,attr,omitempty"`

	//
	// Indicates whether or not this AccessPoint instance supports generation of duress events.
	//

	Duress bool `xml:"Duress,attr,omitempty"`
	...
	AnonymousAccess bool `xml:"AnonymousAccess,attr,omitempty"`
	...
	AccessTaken bool `xml:"AccessTaken,attr,omitempty"`
	...
	ExternalAuthorization bool `xml:"ExternalAuthorization,attr,omitempty"`
}
