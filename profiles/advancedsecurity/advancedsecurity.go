...
type CreateRSAKeyPair struct {
	...
	KeyLength *NonNegativeInteger `xml:"KeyLength,omitempty"`
...
type UploadKeyPairInPKCS8 struct {
	...
	KeyPair *Base64DERencodedASN1Value `xml:"KeyPair,omitempty"`
...
type UploadCertificateWithPrivateKeyInPKCS12 struct {
	...
	CertWithPrivateKey *Base64DERencodedASN1Value `xml:"CertWithPrivateKey,omitempty"`
...
type CreatePKCS10CSR struct {
	...
	Subject *DistinguishedName `xml:"Subject,omitempty"`
	...
	SignatureAlgorithm *AlgorithmIdentifier `xml:"SignatureAlgorithm,omitempty"`
}
...
type CreateSelfSignedCertificate struct {
	...
	X509Version *PositiveInteger `xml:"X509Version,omitempty"`
...
type UploadCertificate struct {
	...
	Certificate *Base64DERencodedASN1Value `xml:"Certificate,omitempty"`
...
type CreateCertificationPath struct {
	...
	CertificateIDs *CertificateIDs `xml:"CertificateIDs,omitempty"`
...
type ReplaceServerCertificateAssignment struct {
	...
	OldCertificationPathID *CertificationPathID `xml:"OldCertificationPathID,omitempty"`

	NewCertificationPathID *CertificationPathID `xml:"NewCertificationPathID,omitempty"`
}
...
type UploadCRL struct {
	...
	//
	Crl *Base64DERencodedASN1Value `xml:"Crl,omitempty"`
...
type CreateCertPathValidationPolicy struct {
	...
	//
	Parameters *CertPathValidationParameters `xml:"Parameters,omitempty"`
...
type ReplaceCertPathValidationPolicyAssignment struct {
	...
	//
	OldCertPathValidationPolicyID *CertPathValidationPolicyID `xml:"OldCertPathValidationPolicyID,omitempty"`

	//
	// The ID of the certification path validation policy to assign to the TLS server.
	//
	NewCertPathValidationPolicyID *CertPathValidationPolicyID `xml:"NewCertPathValidationPolicyID,omitempty"`
}
...
type DNAttributeTypeAndValue struct {
	...
	// The attribute type.
	Type *DNAttributeType `xml:"Type,omitempty"`

	// The value of the attribute.
	Value *DNAttributeValue `xml:"Value,omitempty"`
}
...
type DistinguishedName struct {
	...
	AnyAttribute struct {
		...
		DomainComponent []*DNAttributeValue `xml:"DomainComponent,omitempty"`
...
type BasicRequestAttribute struct {
	...
	OID *DotDecimalOID `xml:"OID,omitempty"`
...
type X509v3Extension struct {
	...
	ExtnValue *Base64DERencodedASN1Value `xml:"extnValue,omitempty"`
}
...
type X509Certificate struct {
	...
	CertificateContent *Base64DERencodedASN1Value `xml:"CertificateContent,omitempty"`
}
...
type Dot1XCapabilities struct {
	...
	MaximumNumberOfDot1XConfigurations *PositiveInteger `xml:"MaximumNumberOfDot1XConfigurations,attr,omitempty"`

	// The authentication methods supported by the 802.1X implementation.

	Dot1XMethods *Dot1XMethods `xml:"Dot1XMethods,attr,omitempty"`
}
...
type Dot1XConfiguration struct {
	...
	Outer *Dot1XStage `xml:"Outer,omitempty"`
}
...
type CRL struct {
	...
	CRLContent *Base64DERencodedASN1Value `xml:"CRLContent,omitempty"`
}
...
type KeystoreCapabilities struct {
	...
	MaximumNumberOfKeys *PositiveInteger `xml:"MaximumNumberOfKeys,attr,omitempty"`

	// Indicates the maximum number of certificates that the device can store simultaneously.

	MaximumNumberOfCertificates *PositiveInteger `xml:"MaximumNumberOfCertificates,attr,omitempty"`

	// Indicates the maximum number of certification paths that the device can store simultaneously.

	MaximumNumberOfCertificationPaths *PositiveInteger `xml:"MaximumNumberOfCertificationPaths,attr,omitempty"`

	// Indication that the device supports on-board RSA key pair generation.

	RSAKeyPairGeneration bool `xml:"RSAKeyPairGeneration,attr,omitempty"`

	// Indicates which RSA key lengths are supported by the device.

	RSAKeyLengths *RSAKeyLengths `xml:"RSAKeyLengths,attr,omitempty"`

	// Indicates support for creating PKCS#10 requests for RSA keys and uploading the certificate obtained from a CA..

	PKCS10ExternalCertificationWithRSA bool `xml:"PKCS10ExternalCertificationWithRSA,attr,omitempty"`

	// Indicates support for creating self-signed certificates for RSA keys.

	SelfSignedCertificateCreationWithRSA bool `xml:"SelfSignedCertificateCreationWithRSA,attr,omitempty"`

	// Indicates which X.509 versions are supported by the device.

	X509Versions *X509Versions `xml:"X509Versions,attr,omitempty"`

	// Indicates the maximum number of passphrases that the device is able to store simultaneously.

	MaximumNumberOfPassphrases *NonNegativeInteger `xml:"MaximumNumberOfPassphrases,attr,omitempty"`

	// Indicates support for uploading an RSA key pair in a PKCS#8 data structure.

	PKCS8RSAKeyPairUpload bool `xml:"PKCS8RSAKeyPairUpload,attr,omitempty"`

	// Indicates support for uploading a certificate along with an RSA private key in a PKCS#12 data structure.

	PKCS12CertificateWithRSAPrivateKeyUpload bool `xml:"PKCS12CertificateWithRSAPrivateKeyUpload,attr,omitempty"`

	// Indicates which password-based encryption algorithms are supported by the device.

	PasswordBasedEncryptionAlgorithms *PasswordBasedEncryptionAlgorithms `xml:"PasswordBasedEncryptionAlgorithms,attr,omitempty"`

	// Indicates which password-based MAC algorithms are supported by the device.

	PasswordBasedMACAlgorithms *PasswordBasedMACAlgorithms `xml:"PasswordBasedMACAlgorithms,attr,omitempty"`

	// Indicates the maximum number of CRLs that the device is able to store simultaneously.

	MaximumNumberOfCRLs *NonNegativeInteger `xml:"MaximumNumberOfCRLs,attr,omitempty"`

	// Indicates the maximum number of certification path validation policies that the device is able to store simultaneously.

	MaximumNumberOfCertificationPathValidationPolicies *NonNegativeInteger `xml:"MaximumNumberOfCertificationPathValidationPolicies,attr,omitempty"`
	...
	EnforceTLSWebClientAuthExtKeyUsage bool `xml:"EnforceTLSWebClientAuthExtKeyUsage,attr,omitempty"`

	// Indicates the device requires that each certificate with private key has its own unique key.

	NoPrivateKeySharing bool `xml:"NoPrivateKeySharing,attr,omitempty"`
}
...
type TLSServerCapabilities struct {
	...
	TLSServerSupported *TLSVersions `xml:"TLSServerSupported,attr,omitempty"`

	// Indicates whether the device supports enabling and disabling specific TLS versions.

	EnabledVersionsSupported bool `xml:"EnabledVersionsSupported,attr,omitempty"`

	// Indicates the maximum number of certification paths that may be assigned to the TLS server simultaneously.

	MaximumNumberOfTLSCertificationPaths *PositiveInteger `xml:"MaximumNumberOfTLSCertificationPaths,attr,omitempty"`

	// Indicates whether the device supports TLS client authentication.

	TLSClientAuthSupported bool `xml:"TLSClientAuthSupported,attr,omitempty"`
	...
	MaximumNumberOfTLSCertificationPathValidationPolicies *NonNegativeInteger `xml:"MaximumNumberOfTLSCertificationPathValidationPolicies,attr,omitempty"`
}

type Capabilities struct {

	// The capabilities of the keystore implementation.
	KeystoreCapabilities *KeystoreCapabilities `xml:"KeystoreCapabilities,omitempty"`

	// The capabilities of the TLS server implementation.
	TLSServerCapabilities *TLSServerCapabilities `xml:"TLSServerCapabilities,omitempty"`
