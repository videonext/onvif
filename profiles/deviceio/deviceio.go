...
type GetVideoOutputConfiguration struct {
	...
	VideoOutputToken *ReferenceToken `xml:"VideoOutputToken,omitempty"`
}
...
type SetVideoOutputConfiguration struct {
	...
	Configuration *VideoOutputConfiguration `xml:"Configuration,omitempty"`
...
type SetRelayOutputSettings struct {
	...
	RelayOutput *RelayOutput `xml:"RelayOutput,omitempty"`
}
...
type GetSerialPortConfiguration struct {
	...
	SerialPortToken *ReferenceToken `xml:"SerialPortToken,omitempty"`
}
...
type SetSerialPortConfiguration struct {
	...
	ForcePersistance bool `xml:"ForcePersistance,omitempty"`
}
...
type Capabilities struct {
	...
	VideoSources int32 `xml:"VideoSources,attr,omitempty"`

	// Number of video outputs (defaults to none).

	VideoOutputs int32 `xml:"VideoOutputs,attr,omitempty"`

	// Number of audio sources (defaults to none).

	AudioSources int32 `xml:"AudioSources,attr,omitempty"`

	// Number of audio outputs (defaults to none).

	AudioOutputs int32 `xml:"AudioOutputs,attr,omitempty"`

	// Number of relay outputs (defaults to none).

	RelayOutputs int32 `xml:"RelayOutputs,attr,omitempty"`

	// Number of serial ports (defaults to none).

	SerialPorts int32 `xml:"SerialPorts,attr,omitempty"`

	// Number of digital inputs (defaults to none).

	DigitalInputs int32 `xml:"DigitalInputs,attr,omitempty"`

	// Indicates support for DigitalInput configuration of the idle state (defaults to false).

	DigitalInputOptions bool `xml:"DigitalInputOptions,attr,omitempty"`
}
...
type RelayOutputOptions struct {
	...
	DelayTimes *DelayTimes `xml:"DelayTimes,omitempty"`
...
type DigitalInputConfigurationOptions struct {
	...
	IdleState []*DigitalIdleState `xml:"IdleState,omitempty"`
}
...
type SerialPortConfiguration struct {
	...
	BaudRate int32 `xml:"BaudRate,omitempty"`

	// The parity for the data error detection.
	ParityBit *ParityBit `xml:"ParityBit,omitempty"`

	// The bit length for each character.
	CharacterLength int32 `xml:"CharacterLength,omitempty"`

	// The number of stop bits used to terminate each character.
	StopBit float32 `xml:"StopBit,omitempty"`
...
type SerialPortConfigurationOptions struct {
	...
	BaudRateList *IntList `xml:"BaudRateList,omitempty"`

	// The list of configurable parity for the data error detection.
	ParityBitList *ParityBitList `xml:"ParityBitList,omitempty"`

	// The list of configurable bit length for each character.
	CharacterLengthList *IntList `xml:"CharacterLengthList,omitempty"`

	// The list of configurable number of stop bits used to terminate each character.
	StopBitList *FloatList `xml:"StopBitList,omitempty"`
