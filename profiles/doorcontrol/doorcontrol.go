...
type AccessDoor struct {
	...
	AccessTime *Duration `xml:"AccessTime,omitempty"`

	// Optional - overrides OpenTime if specified.
	//
	OpenTooLongTime *Duration `xml:"OpenTooLongTime,omitempty"`

	// Optional - overrides PreAlarmTime if specified.
	PreAlarmTime *Duration `xml:"PreAlarmTime,omitempty"`
...
type ServiceCapabilities struct {
	...
	MaxDoors uint32 `xml:"MaxDoors,attr,omitempty"`
...
type DoorInfo struct {
	*DoorInfoBase
	...
	Capabilities *DoorCapabilities `xml:"Capabilities,omitempty"`
}
...
type Timings struct {
	...
	//
	ExtendedReleaseTime *Duration `xml:"ExtendedReleaseTime,omitempty"`
	...
	//
	DelayTimeBeforeRelock *Duration `xml:"DelayTimeBeforeRelock,omitempty"`
	...
	//
	ExtendedOpenTime *Duration `xml:"ExtendedOpenTime,omitempty"`
...
type DoorState struct {
	...
	//
	DoorMode *DoorMode `xml:"DoorMode,omitempty"`
}
...
type DoorTamper struct {
	...
	//
	State *DoorTamperState `xml:"State,omitempty"`
}
...
type DoorFault struct {
	...
	// to this structure.
	//
	State *DoorFaultState `xml:"State,omitempty"`
}
