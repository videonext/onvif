...
type GetServiceCapabilitiesResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl GetServiceCapabilitiesResponse"`

	// The capabilities for the imaging service is returned in the Capabilities element.
	Capabilities Capabilities `xml:"http://www.onvif.org/ver20/imaging/wsdl Capabilities,omitempty"`
}
...
type GetOptionsResponse struct {
	...
	//
	ImagingOptions ImagingOptions20 `xml:"http://www.onvif.org/ver20/imaging/wsdl ImagingOptions,omitempty"`
}
...
type GetMoveOptionsResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl GetMoveOptionsResponse"`

	//
	// Valid ranges for the focus lens move options.
	//
	MoveOptions MoveOptions20 `xml:"http://www.onvif.org/ver20/imaging/wsdl MoveOptions,omitempty"`
}
...
type StopResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl StopResponse"`
}
...
type GetStatusResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl GetStatusResponse"`

	//
	// Requested imaging status.
	//
	Status ImagingStatus20 `xml:"http://www.onvif.org/ver20/imaging/wsdl Status,omitempty"`
}
...
type GetPresetsResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl GetPresetsResponse"`

	//
	// List of Imaging Presets which are available for the requested VideoSource.
	//
	Preset ImagingPreset `xml:"http://www.onvif.org/ver20/imaging/wsdl Preset,omitempty"`
}
...
type GetCurrentPresetResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl GetCurrentPresetResponse"`
...
type SetCurrentPresetResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver20/imaging/wsdl SetCurrentPresetResponse"`
}
...
type StringItems struct {
	...
	Item string `xml:"http://www.onvif.org/ver20/imaging/wsdl Item,omitempty"`
}
...
type SystemLog struct {
	...
	String string `xml:"http://www.onvif.org/ver20/imaging/wsdl String,omitempty"`
}
...
type MotionExpression struct {
	...
	Expression string `xml:"http://www.onvif.org/ver20/imaging/wsdl Expression,omitempty"`

	Type string `xml:"http://www.onvif.org/ver20/imaging/wsdl Type,attr,omitempty"`
}
