...
type ConfigurationEnumeration ConfigurationEnumeration
...
type SetVideoEncoderConfiguration struct {
	...
	Configuration *VideoEncoder2Configuration `xml:"Configuration,omitempty"`
}
...
type SetAudioEncoderConfiguration struct {
	...
	Configuration *AudioEncoder2Configuration `xml:"Configuration,omitempty"`
}
...
type Capabilities2 struct {
	...
	SourceMask bool `xml:"SourceMask,attr,omitempty"`
}
...
type ProfileCapabilities struct {
	...
	ConfigurationsSupported *StringAttrList `xml:"ConfigurationsSupported,attr,omitempty"`
}
...
type StreamingCapabilities struct {
	...
	RTSPStreaming bool `xml:"RTSPStreaming,attr,omitempty"`
	...
	RTSPWebSocketUri *AnyURI `xml:"RTSPWebSocketUri,attr,omitempty"`

	// Indicates support for non-RTSP controlled multicast streaming.

	AutoStartMulticast bool `xml:"AutoStartMulticast,attr,omitempty"`
}
...
type ConfigurationSet struct {
	...
	VideoSource *VideoSourceConfiguration `xml:"VideoSource,omitempty"`

	// Optional configuration of the Audio input.
	AudioSource *AudioSourceConfiguration `xml:"AudioSource,omitempty"`

	// Optional configuration of the Video encoder.
	VideoEncoder *VideoEncoder2Configuration `xml:"VideoEncoder,omitempty"`

	// Optional configuration of the Audio encoder.
	AudioEncoder *AudioEncoder2Configuration `xml:"AudioEncoder,omitempty"`

	// Optional configuration of the analytics module and rule engine.
	Analytics *VideoAnalyticsConfiguration `xml:"Analytics,omitempty"`

	// Optional configuration of the pan tilt zoom unit.
	PTZ *PTZConfiguration `xml:"PTZ,omitempty"`

	// Optional configuration of the metadata stream.
	Metadata *MetadataConfiguration `xml:"Metadata,omitempty"`

	// Optional configuration of the Audio output.
	AudioOutput *AudioOutputConfiguration `xml:"AudioOutput,omitempty"`

	// Optional configuration of the Audio decoder.
	AudioDecoder *AudioDecoderConfiguration `xml:"AudioDecoder,omitempty"`
}
...
type MaskOptions struct {
	...
	MaxMasks int32 `xml:"MaxMasks,omitempty"`

	// Maximum supported number of points per mask.
	MaxPoints int32 `xml:"MaxPoints,omitempty"`
	...
	RectangleOnly bool `xml:"RectangleOnly,attr,omitempty"`
	...
	SingleColorOnly bool `xml:"SingleColorOnly,attr,omitempty"`
}
