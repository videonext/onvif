...
type PanMove struct {
	...
	// "left" or "right".
	Direction *PanDirection `xml:"Direction,omitempty"`
...
type TiltMove struct {
	...
	// "up" or "down".
	Direction *TiltDirection `xml:"Direction,omitempty"`
...
type ZoomMove struct {
	...
	// "wide" or "telephoto".
	Direction *ZoomDirection `xml:"Direction,omitempty"`
...
type RollMove struct {
	...
	Direction *RollDirection `xml:"Direction,omitempty"`
