...
type GetConfiguration struct {
	...
	//
	PTZConfigurationToken *ReferenceToken `xml:"PTZConfigurationToken,omitempty"`
}
...
type SendAuxiliaryCommand struct {
	...
	//
	AuxiliaryData *AuxiliaryData `xml:"AuxiliaryData,omitempty"`
}
...
type ContinuousMove struct {
	...
	//
	Velocity *PTZSpeed `xml:"Velocity,omitempty"`
...
type RelativeMove struct {
	...
	//
	Translation *PTZVector `xml:"Translation,omitempty"`
...
type GeoMove struct {
	...
	//
	Target *GeoLocation `xml:"Target,omitempty"`
...
type OperatePresetTour struct {
	...
	Operation *PTZPresetTourOperation `xml:"Operation,omitempty"`
}
