...
type Capabilities struct {
	...
	RTP_Multicast bool `xml:"RTP_Multicast,attr,omitempty"`
	...
	SupportedReceivers int32 `xml:"SupportedReceivers,attr,omitempty"`

	// The maximum allowed length for RTSP URIs (Minimum and default value is 128 octet).

	MaximumRTSPURILength int32 `xml:"MaximumRTSPURILength,attr,omitempty"`
}
