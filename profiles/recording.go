...
type ExportRecordedData struct {
	...
	SearchScope *SearchScope `xml:"SearchScope,omitempty"`
	...
	StorageDestination *StorageReferencePath `xml:"StorageDestination,omitempty"`
}
...
type Capabilities struct {
	...
	DynamicRecordings bool `xml:"DynamicRecordings,attr,omitempty"`

	// Indication if the device supports dynamic creation and deletion of tracks

	DynamicTracks bool `xml:"DynamicTracks,attr,omitempty"`
	...
	SupportedExportFileFormats *StringAttrList `xml:"SupportedExportFileFormats,attr,omitempty"`
}

type RecordingOptions struct {
	Job *JobOptions `xml:"Job,omitempty"`

	Track *TrackOptions `xml:"Track,omitempty"`
}
...
type JobOptions struct {
	...
	Spare int32 `xml:"Spare,attr,omitempty"`
	...
	CompatibleSources *StringAttrList `xml:"CompatibleSources,attr,omitempty"`
}
