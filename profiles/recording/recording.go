...
type GetServiceCapabilitiesResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetServiceCapabilitiesResponse"`

	// The capabilities for the recording service is returned in the Capabilities element.
	Capabilities Capabilities `xml:"http://www.onvif.org/ver10/recording/wsdl Capabilities,omitempty"`
}
...
type CreateRecordingResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl CreateRecordingResponse"`
...
type DeleteRecordingResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl DeleteRecordingResponse"`
}
...
type GetRecordingsResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingsResponse"`

	// List of recording items.
	RecordingItem GetRecordingsResponseItem `xml:"http://www.onvif.org/ver10/recording/wsdl RecordingItem,omitempty"`
}
...
type SetRecordingConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetRecordingConfigurationResponse"`
}
...
type GetRecordingConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingConfigurationResponse"`
...
type CreateTrackResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl CreateTrackResponse"`
...
type DeleteTrackResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl DeleteTrackResponse"`
}
...
type GetTrackConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetTrackConfigurationResponse"`
...
type SetTrackConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetTrackConfigurationResponse"`
}
...
type CreateRecordingJobResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl CreateRecordingJobResponse"`
...
type DeleteRecordingJobResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl DeleteRecordingJobResponse"`
}
...
type GetRecordingJobsResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingJobsResponse"`

	// List of recording jobs.
	JobItem GetRecordingJobsResponseItem `xml:"http://www.onvif.org/ver10/recording/wsdl JobItem,omitempty"`
}
...
type SetRecordingJobConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetRecordingJobConfigurationResponse"`
...
type GetRecordingJobConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingJobConfigurationResponse"`
...
type SetRecordingJobModeResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl SetRecordingJobModeResponse"`
}
...
type GetRecordingJobStateResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingJobStateResponse"`

	// The current state of the recording job.
	State RecordingJobStateInformation `xml:"http://www.onvif.org/ver10/recording/wsdl State,omitempty"`
}
...
type GetRecordingOptionsResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetRecordingOptionsResponse"`

	// Configuration of the recording.
	Options RecordingOptions `xml:"http://www.onvif.org/ver10/recording/wsdl Options,omitempty"`
}
...
type ExportRecordedDataResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl ExportRecordedDataResponse"`
	...
	FileNames string `xml:"http://www.onvif.org/ver10/recording/wsdl FileNames,omitempty"`
...
type StopExportRecordedDataResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl StopExportRecordedDataResponse"`
	...
	FileProgressStatus ArrayOfFileProgress `xml:"http://www.onvif.org/ver10/recording/wsdl FileProgressStatus,omitempty"`
}
...
type GetExportRecordedDataStateResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/recording/wsdl GetExportRecordedDataStateResponse"`
...
type StringItems struct {
	...
	Item string `xml:"http://www.onvif.org/ver10/recording/wsdl Item,omitempty"`
}
...
type SystemLog struct {
	...
	String string `xml:"http://www.onvif.org/ver10/recording/wsdl String,omitempty"`
}
...
type MotionExpression struct {
	...
	Expression string `xml:"http://www.onvif.org/ver10/recording/wsdl Expression,omitempty"`

	Type string `xml:"http://www.onvif.org/ver10/recording/wsdl Type,attr,omitempty"`
}
...
type GetRecordingsResponseItem struct {
	...
	// Configuration of the recording.
	Configuration RecordingConfiguration `xml:"http://www.onvif.org/ver10/recording/wsdl Configuration,omitempty"`

	// List of tracks.
	Tracks GetTracksResponseList `xml:"http://www.onvif.org/ver10/schema Tracks,omitempty"`
}

type GetTracksResponseList struct {

	// Configuration of a track.
	Track GetTracksResponseItem `xml:"http://www.onvif.org/ver10/schema Track,omitempty"`
}
...
type GetTracksResponseItem struct {
	...
	// Configuration of the track.
	Configuration TrackConfiguration `xml:"http://www.onvif.org/ver10/recording/wsdl Configuration,omitempty"`
}
