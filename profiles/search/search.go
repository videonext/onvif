...
type GetMediaAttributes struct {
	...
	RecordingTokens []*RecordingReference `xml:"RecordingTokens,omitempty"`
...
type FindRecordings struct {
	...
	Scope *SearchScope `xml:"Scope,omitempty"`
	...
	KeepAliveTime *Duration `xml:"KeepAliveTime,omitempty"`
}
...
type GetRecordingSearchResults struct {
	...
	WaitTime *Duration `xml:"WaitTime,omitempty"`
}
...
type FindEvents struct {
	...
	SearchFilter *EventFilter `xml:"SearchFilter,omitempty"`
	...
	IncludeStartState bool `xml:"IncludeStartState,omitempty"`
...
type FindPTZPosition struct {
	...
	SearchFilter *PTZPositionFilter `xml:"SearchFilter,omitempty"`
...
type FindMetadata struct {
	...
	MetadataFilter *MetadataFilter `xml:"MetadataFilter,omitempty"`
...
type Capabilities struct {
	MetadataSearch bool `xml:"MetadataSearch,attr,omitempty"`

	// Indicates support for general virtual property events in the FindEvents method.

	GeneralStartEvents bool `xml:"GeneralStartEvents,attr,omitempty"`
}
