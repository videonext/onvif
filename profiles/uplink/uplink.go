...
type GetServiceCapabilitiesResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl GetServiceCapabilitiesResponse"`

	// The capabilities for the uplink service is returned in the Capabilities element.
	Capabilities Capabilities `xml:"http://www.onvif.org/ver10/uplink/wsdl Capabilities,omitempty"`
}
...
type GetUplinksResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl GetUplinksResponse"`
...
type SetUplinkResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl SetUplinkResponse"`
}
...
type DeleteUplinkResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/uplink/wsdl DeleteUplinkResponse"`
}
...
type StringItems struct {
	...
	Item string `xml:"http://www.onvif.org/ver10/uplink/wsdl Item,omitempty"`
}
...
type SystemLog struct {
	...
	String string `xml:"http://www.onvif.org/ver10/uplink/wsdl String,omitempty"`
}
...
type MotionExpression struct {
	...
	Expression string `xml:"http://www.onvif.org/ver10/uplink/wsdl Expression,omitempty"`

	Type string `xml:"http://www.onvif.org/ver10/uplink/wsdl Type,attr,omitempty"`
}
